...
const Header = (data: any) => (
  ...
  <div className="collapse navbar-collapse text-right" id="navbarTogglerDemo01">
    <ul className="navbar-nav navbar-right">
      ...
      <a className="btn navbar-btn btn-default border-warning py-1 mx-1" href="/#">خانه<span className="sr-only">(current)</span></a>
      </li>
      <li className="nav-item">
      <a className="btn navbar-btn btn-default border-warning py-1 mx-1" href="/contact">{data.info.contactTitle}</a>
      </li>
    </ul>
  </div>  
    </nav>
